...
const Service = () => {
  return (
    <section className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px] font-montserrat">
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-white p-10 shadow-xl hover:shadow-2xl dark:bg-dark-2 md:px-7 xl:px-10">
          <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-blue-700 animate-fadeIn">
            {icon}
          </div>
          <h4 className="mb-[14px] text-2xl font-semibold text-dark dark:text-black animate-fadeIn">
            {title}
          </h4>
          <p className="text-body-color dark:text-dark-6 animate-fadeIn">{details}</p>
        </div>
      </div>
    </>
  );
