    ...
    return (
        <>
                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">
                            We are committed to providing you with the best solutions for your legal needs and business growth. We approach every client with a focus on integrity, advocacy, and understanding. We fight for you!
                        </p>
                    </div>
                    ...
                    <ul className="max-w-md mx-auto mt-16 space-y-12">
                        <li className="relative flex items-start">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="mt-4 text-base text-gray-600">
                                    Signup to LegalizeMe and get started with your legal needs. We provide you with the best solutions for your legal needs and business growth.
                                </p>
                            </div>
                        </li>
                        ...
                        <li className="relative flex items-start">
                            ...
                            <div className="ml-6">
                                <h3 className="text-lg font-semibold text-black">Find Solutions to Your Legal Need</h3>
                                <p className="mt-4 text-base text-gray-600">
                                    Navigate to the cases section and find the best solutions to your legal needs. Get started with your LegalizeMe and explore the best solutions.
                                </p>
                            </div>
                        </li>
                        ...
                        <li className="relative flex items-start">
                            ...
                            <div className="ml-6">
                                <h3 className="text-lg font-semibold text-black">Interact with "Counsel"</h3>
                                <p className="mt-4 text-base text-gray-600">
                                    Interact with "Counsel", our AI powered chatbot, to get instant solutions to your legal needs. Counsel is available 24/7 to help you with your queries. Generate legal documents and get them verified by our legal experts.
                                </p>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
                        <div>
                            ...
                            <h3 class="mt-8 text-lg font-semibold text-black">Comprehensive Legal Database</h3>
                            <p class="mt-4 text-base text-gray-600">
                                Imagine having the entire legal world at your disposal. Our platform gives you instant access to an extensive legal database packed with case law
                                precedent and other legal documents. Say goodbye to endless searches - our AI-powered search engine delivers only the most relevant results, summarized and
                                ready to use. Legal researc has never been this easy. Welcome to the future of law.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 class="mt-8 text-lg font-semibold text-black">Automated Legal Document Generation</h3>
                            <p class="mt-4 text-base text-gray-600">
                                Why waste time on tedious paperwork? With just a few inputs, our system generates tailoremade lega documents in minutes - no hassle,
                                no fuss. Whether it's contracts, agreements, or policies, we've got you covered. And for transparency, each document is watermarked
                                as a draft until it is legally validated. Precision, speed, and control - right at your fingertips.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <h3 class="mt-8 text-lg font-semibold text-black">Your Legal Ally on Every Step of Your Journey</h3>
                            <p class="mt-4 text-base text-gray-600">
                                We are more than just a platform - we are your trusted legal ally. Whether you're drafting documents, conducting research, or navigating complexities, we're here to
                                simplify the process, reduce uncertainity, and empower you to succeed. Our team of legal experts is always on standby to provide guidance and support. With LegalizeMe, you're never alone.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 animate-fadeIn font-roboto">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">Trusted by <span className="text-blue-600">renowned</span> world className companies & design teams</h2>
                    </div>
