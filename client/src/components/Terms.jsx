                ...
                <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="flow-root mt-12 sm:mt-16">
                        <div className="divide-y divide-gray-200 -my-9">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">Welcome to LegalizeMe</p>
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">1. Acceptance of Terms</p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>1.1 Eligibility:</strong> By creating an account or accessing the Platform, you confirm that you are at least 18 years of age, or the age of legal majority in your jurisdiction, and are legally capable of entering into this agreement.
                                    You
                                    represent and warrant that all information provided is accurate, complete, and up-to-date, and that your
                                    use of the Platform complies with all applicable laws and regulations.
                                </p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>1.2 Binding Agreement:</strong> These Terms constitute a legally binding agreement between you and LegalizeMe. By accessing the Platform, you consent to abide by these Terms and any applicable rules or regulations.
                                </p>
                            </div>

                            {/* Modification of Terms Section */}
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">2. Modification of Terms</p>
                                <p className="mt-3 text-base text-gray-600">
                                    LegalizeMe reserves the right to amend or modify these Terms at any time. Updates will be posted on the Platform and may be communicated via email or in-app notifications.
                                    Your continued use of the Platform
                                    following any updates constitutes acceptance of the revised Terms. Material changes will be clearly
                                    indicated, and we encourage regular review of these Terms. Should you disagree with any modifications,
                            ...
                            {/* LegalizeMe Services */}
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">3. LegalizeMe Services</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">4. Account Responsibilities</p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>4.1 Account Creation:</strong> To access certain Platform features, you are required to create an account. You agree to provide accurate, current, and complete information during registration and to update such information as needed. Failure to maintain accurate information may result in account suspension or termination.
                                </p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>4.2 Security and Unauthorized Use:</strong> You are responsible for safeguarding your account credentials (e.g., username and password). You must promptly notify us of any security breach, unauthorized access, or suspicious activity. LegalizeMe disclaims all liability for loss or damages resulting from unauthorized account use.
                                </p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>4.3 Prohibited Uses:</strong> You agree not to:
                                    <ul className="list-disc list-inside">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">5. Intellectual Property Rights</p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>5.1 Ownership:</strong> All content on the Platform—including templates, AI models, algorithms, design elements, text, graphics, and code—is the intellectual property of LegalizeMe or its licensors, protected by copyright, trademark, and other intellectual property laws.
                                </p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>5.2 User-Generated Content:</strong> By submitting content (e.g., documents, comments, feedback), you grant LegalizeMe a perpetual, non-exclusive, royalty-free, worldwide license to use, modify, distribute, and display your content for the purposes of Platform operation and enhancement. You retain ownership of your content, while LegalizeMe retains rights necessary for service optimization.
                                </p>
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>5.3 Kenya Law Data Attribution:</strong> Some legal content (e.g., case law) is sourced from <a href="https://kenyalaw.org/kl/" className="text-blue-500 underline" target="_blank">Kenya Law Report: Home Page</a> and is licensed under the <a href="https://creativecommons.org/licenses/by/4.0/" className="text-blue-500 underline" target="_blank">Creative Commons Attribution 4.0 International License</a>. Users must comply with this license, including providing proper attribution and links to the original source.
                                </p>
                            </div>
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">6. License to Use</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            {/* No Legal Advice Disclaimer Section */}
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">7. No Legal Advice Disclaimer</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">8. Limitation of Liability</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            {/* Termination Section */}
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">9. Termination</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            {/* Jurisdiction */}
                            <div className="py-9">
                                {/* Repeat similar blocks for each section like Account Responsibilities, Intellectual Property, Governing Law, etc., as needed */}
                                <p className="text-xl font-semibold text-black">10. Governing Law and Jurisdiction</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">11. Force Majeure</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">12. Indemnification</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">13. Dispute Resolution</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">14. Entire Agreement</p>
                                <p className="mt-3 text-base text-gray-600">
                            ...
                            <div className="py-9">
                                <p className="text-xl font-semibold text-black">15. Contact Information</p>
                                <p className="mt-3 text-base text-gray-600">
                                ...
                                <p className="mt-3 text-base text-gray-600">
                                    <strong>By continuing to use the Platform, you confirm that you have read, understood, and agreed to these Terms of Service.</strong>
                                </p>
                            </div>
                        </div>
                    </div>
