                    ...
                    <div className="w-full max-w-4xl mx-auto mt-8 space-y-4 lg:space-y-0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <select
                                ...
                                className="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500"
                            >
                        ...
                        {(selectedClassification || selectedCounty || selectedCourt || searchQuery) && (
                            <button
