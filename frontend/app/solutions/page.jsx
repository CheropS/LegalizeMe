            ...
            {[
              {
                ...
                description: "Unlock instant access to a vast library of case law, precedents, and essential legal documents—all powered by AI for quick, precise search results.",
                icon: (
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
