                ...
                <div className="grid items-center md:grid-cols-2 gap-y-8 md:gap-x-28">
                    ...
                    >
                        ...
                        >     
                            ...
                            >
                                <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg opacity-25 blur group-hover:opacity-50 transition-duration-1000 group-hover:duration-200" />
